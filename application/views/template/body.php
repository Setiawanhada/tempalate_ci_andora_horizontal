					...
					<div class="container">
											...
											<div class="col-md-6 col-lg-6">
												...
												<div class="form-group">
													...
													<div class="row gutters-xs">
														...
														<span class="col-auto">
															<button class="btn btn-primary" type="button"><i class="fe fe-search text-white"></i></button>
														</span>
													</div>
												</div>
												<div class="form-group">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title">Form Different Heights</div>
									</div>
									<div class="card-body">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title">Date pickers</div>
									</div>
									<div class="card-body">
						...
						<div class="container">
							<div class="row align-items-center flex-row-reverse">
								<div class="col-lg-12 col-sm-12 mt-3 mt-lg-0 text-center">
									Copyright © 2019 <a href="#">Andora</a>. Designed by <a href="#">Spruko</a> All rights reserved.
								</div>
							</div>
						</div>
					</footer>
